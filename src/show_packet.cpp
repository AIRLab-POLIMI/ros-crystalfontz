...
const char *command_names[36] = {
		...
		" 9 = LCD CGRAM", "10 = Read LCD Memory", "11 = Place Cursor",
		"12 = Set Cursor Style", "13 = Contrast", "14 = Backlight",
		"15 = Read Fans", "16 = Set Fan Rpt.", "17 = Set Fan Power",
		"18 = Read DOW ID", "19 = Set Temp. Rpt", "20 = DOW Transaction",
		"21 = Set Live Display", "22 = Direct LCD Command",
		"23 = Set Key Event Reporting", "24 = Read Keypad, Polled Mode",
		"25 = Set Fan Fail-Safe", "26 = Set Fan RPM Glitch Filter",
		"27 = Read Fan Pwr & Fail-Safe", "28 = Set ATX switch functionality",
		"29 = Watchdog Host Reset", "30 = Rd Rpt",
		"31 = Send Data to LCD (row,col)", "32 = Key Legends",
		"33 = Set Baud Rate", "34 = Set/Configure GPIO",
		"35 = Read GPIO & Configuration" };
const char *error_names[36] = { "Error: Ping", "Error: Version",
		"Error: Write Flash", "Error: Read Flash", "Error: Store Boot State",
		"Error: Reboot", "Error: Clear LCD", "Error: Set LCD 1",
		"Error: Set LCD 2", "Error: Set LCD CGRAM", "Error: Read LCD Memory",
		"Error: Place LCD Cursor", "Error: LCD Cursor Style",
		"Error: Contrast", "Error: Backlight", "Error: Query Fan",
		"Error: Set Fan Rept.", "Error: Set Fan Power", "Error: Read DOW ID",
		"Error: Set Temp. Rept.", "Error: DOW Transaction",
		"Error: Setup Live Disp", "Error: Direct LCD Command",
		"Error: Set Key Event Reporting", "Error: Read Keypad, Polled Mode",
		"Error: Set Fan Fail-Safe", "Error: Set Fan RPM Glitch Filter",
		"Error: Read Fan Pwr & Fail-Safe",
		"Error: Set ATX switch functionality", "Error: Watchdog Host Reset",
		"Error: Read  Reporting/ATX/Watchdog",
		"Error: Send Data to LCD (row,col)", "Error: Key Legends",
		"Error: Set Baud Rate", "Error: Set/Configure GPIO",
		"Error: Read GPIO & Configuration" };
const char *key_names[21] = { "KEY_NONE", "KEY_UP_PRESS", "KEY_DOWN_PRESS",
		...
		"KEY_EXIT_RELEASE", "KEY_UL_PRESS", "KEY_UR_PRESS", "KEY_LL_PRESS",
...
void showReceivedPacket(void) {
	...
	for (i = 0; i < incoming_command.data_length; i++) {
		if (isprint(incoming_command.data[i])) {
			int current_length = strlen(expanded);
	...
	if (incoming_command.command == 0x80)
		ROS_INFO(
				...
				incoming_command.data[0] <= 20 ? key_names[incoming_command.data[0]]
						: "HUH?", incoming_command.data_length, expanded,
		...
		ROS_INFO(
				...
				((incoming_command.command & 0xC0) == 0xC0) ? error_names[0x3F
						& incoming_command.command] : command_names[0x3F
						& incoming_command.command],
				incoming_command.data_length, expanded,
				incoming_command.CRC.as_word);
}
//============================================================================
